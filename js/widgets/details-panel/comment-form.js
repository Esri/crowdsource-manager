    ...
    return declare([_WidgetBase, _TemplatedMixin], {
        ...
        */
        postCreate: function () {
            ...
            on(this.postCommentButton, 'click', lang.hitch(this, function () {
                ...
                this.appUtils.showMessage("Comments submission coming soon..");
            }));
        ...
        */
        _submitCommentForm: function () {
            var featureData, editedFields = [],
                key, picker, datePicker, value, erroneousFields = [],
                commentFormDiv;
            ...
            if (erroneousFields.length !== 0) {
                ...
                this._primaryKeyField = this._selectedLayer.relationships[0].keyField;
                this._foreignKeyField = this.commentTable.relationships[0].keyField;
                featureData.attributes[this._foreignKeyField] = this._item.attributes[this._primaryKeyField];
                ...
                this.commentTable.applyEdits([featureData], null, null, lang.hitch(this, function (results) {
                    ...
                    if (results[0].success) {
                        ...
                        this.onCommentFormSubmitted(this._item);
                    } else {
            ...
            if ((currentField.domain && (currentField.domain.type === 'undefined' || currentField.domain.type === undefined || currentField.domain.type === 'codedValue')) || currentField.typeField) {
                ...
                if (currentField.type === "esriFieldTypeDate") {
                    ...
                    if (currentField.defaultValue) {
                        ...
                        this._defaultValueArray.push({
                            defaultValue: rangeDefaultDate,
        ...
        */
        _setRangeForm: function (currentField, formContent, fieldname) {
            var setStep, setDefault = "",
                ...
                decimalPoints = 0,
                inputcontentSpinner, _rangeHelpText;
            ...
            // Set minimum and maximum value to the _rangeHelpText
            _rangeHelpText = string.substitute(this.config.i18n.geoform.numericRangeHintMessage, {
        ...
        */
        _clearFormFields: function () {
            ...
            array.forEach(query(".form-control", this.domNode), lang.hitch(this, function (currentInput) {
                for (index = 0; index < this._defaultValueArray.length; index++) {
                    if (this._defaultValueArray[index].id === currentInput.id) {
                        if (this._defaultValueArray[index].type === "esriFieldTypeDate" || this._defaultValueArray[index].type === "range") {
                            domClass.add(currentInput.parentElement.parentElement, "has-success");
                        } else {
                            domClass.add(currentInput.parentElement, "has-success");
                        }
                        if (!domClass.contains(currentInput, "selectDomain")) {
                            domAttr.set(currentInput, "value", this._defaultValueArray[index].defaultValue);
                        }
                        if (this._defaultValueArray[index].type === "esriFieldTypeDate") {
                            $(currentInput.parentElement).data('DateTimePicker').setValue(this._defaultValueArray[index].defaultValue);
                        }
                    }
                }
            }));
        ...
        */
        _validateField: function (currentNode, currentField, iskeyPress) {
            var inputType, inputValue, node, typeCastedInputValue, error, targetNode = currentNode.currentTarget || currentNode.srcElement,
